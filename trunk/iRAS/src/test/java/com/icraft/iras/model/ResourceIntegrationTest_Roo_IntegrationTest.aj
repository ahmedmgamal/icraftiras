...
import com.icraft.iras.model.ResourceDataOnDemand;
...
privileged aspect ResourceIntegrationTest_Roo_IntegrationTest {
    ...
    public void ResourceIntegrationTest.testCountResources() {
        ...
        long count = com.icraft.iras.model.Resource.countResources();
    ...
    public void ResourceIntegrationTest.testFindResource() {
        com.icraft.iras.model.Resource obj = dod.getRandomResource();
        ...
        obj = com.icraft.iras.model.Resource.findResource(id);
    ...
    public void ResourceIntegrationTest.testFindAllResources() {
        ...
        java.util.List<com.icraft.iras.model.Resource> result = com.icraft.iras.model.Resource.findAllResources();
    ...
    public void ResourceIntegrationTest.testFindResourceEntries() {
        ...
        java.util.List<com.icraft.iras.model.Resource> result = com.icraft.iras.model.Resource.findResourceEntries(0, (int) count);
    ...
    public void ResourceIntegrationTest.testMerge() {
        ...
        boolean modified =  dod.modifyResource(obj);
        java.lang.Integer currentVersion = obj.getVersion();
        com.icraft.iras.model.Resource merged = (com.icraft.iras.model.Resource) obj.merge();
        obj.flush();
    ...
    public void ResourceIntegrationTest.testPersist() {
        org.junit.Assert.assertNotNull("Data on demand for 'Resource' failed to initialize correctly", dod.getRandomResource());
        com.icraft.iras.model.Resource obj = dod.getNewTransientResource(Integer.MAX_VALUE);
    ...
    public void ResourceIntegrationTest.testRemove() {
        ...
        obj.remove();
        obj.flush();
        org.junit.Assert.assertNull("Failed to remove 'Resource' with identifier '" + id + "'", com.icraft.iras.model.Resource.findResource(id));
    }
